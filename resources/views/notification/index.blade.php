                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <!-- <a class="btn btn-primary" href="javascript:void(0)" id="createNewCustomer"><i class="fe-plus-circle"></i>image size</a>
                                -->
                                    <a class="btn btn-primary" href="{{ route('admin-notification.create') }}"><i class="fe-plus-circle"> Create Notification </i></a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ ++$i }}</td>
                                    @php $users = App\User::where('id' , $slider->user_id)->first(); @endphp
                                    <td>
                                        @if($users)
                                            {{ $users->name }}
                                        @else
                                    ...
                                    <div class="kanban-menu">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right action-btn"
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('admin-notification.edit',$slider->id) }}">
                                                        <i class="feather icon-edit-2 mr-2"></i>@translate(Edit)</a>
                                                    <a class="dropdown-item"  onclick="confirm_modal('{{ route('notification-destroy', $slider->id) }}')">
