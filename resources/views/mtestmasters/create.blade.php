...
@section('content')
    ...
    <div class="card m-2">
        ...
        <div class="card-body">
            <form action="{{ route('mtestmasters.store') }}" method="POST">
                @csrf
                    ...
                    <div class="form-group col-md-3 p-3">
                            ...
                            <div class="">
                                <select class="form-control langr selectpicker" id="test_type" name="test_type">
                                    ...
                                    <option value="Mock" {{ (old('test_type') == 'Mock')?'selected':'' }}>Mock Test</option>
                                    <option value="Practice" {{ (old('test_type') == 'Practice')?'selected':'' }}>Practice Test</option>
                                    <option value="Sectional" {{ (old('test_type') == 'Sectional')?'selected':'' }}>Sectional Test</option>
                        ...
                        <div class="form-group col-md-3 p-3">
                            ...
                            <div class="">
                                <select class="form-control langr selectpicker" id="test" name="test">
                                    ...
                                    <option value="Chapter" {{ (old('test') == 'Chapter')?'selected':'' }}>Chapter</option>
                                    <option value="Full" {{ (old('test') == 'Full')?'selected':'' }}>Full</option>
                                    <option value="Sectional" {{ (old('test') == 'Sectional')?'selected':'' }}>Sectional</option>
                    ...
                    <div class="form-group col-md-6 p-3">
                            <label class="" for="name">
                                ...
                                <div class="bootstrap-tagsinput">
                                    <input type="text"  class="form-control langr" placeholder="@translate(Enter Mock Test Name)"  id="name" name="name" value="{{old('name')}}">
                                </div>
                        </div>
                        <div class="form-group col-md-4 p-3">
                            ...
                            <div class="">
                                <select class="form-control langr selectpicker" id="course_type" name="course_type">
