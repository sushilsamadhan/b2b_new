...
<section class="py-3">
    <div class="container">
        <h2>Add New Mentor</h2>
            <div class="row ">
                <div class="col-md-12">                  
                    <form class="needs-validation" enctype="multipart/form-data" method="post"  action="{{ url('upload-mentor') }}" novalidate>                                        
                        @csrf
                        <div class="row">                        
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    ...
                                    <textarea type="text" class="form-control form-control-sm " id="experience" placeholder="experience" name="experience"  required ></textarea>
                                    <div class="invalid-feedback">
                                        Experience required
                                    </div>
                                </div>
                        ...
                        <div class="row">                                                    
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control form-control-sm" id="photo" placeholder="photo" name="photo" >                                                       
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-inverse font-weight-bold small" for="title" >Profile Title<span class="text-danger">*</span></label>
                                    <input type="text" id="title" class="form-control form-control-sm"  placeholder="title" name="profile_title"  required>
                                    @error('title')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    ...
                                    <textarea type="text" id="discription" class="form-control form-control-sm summernote"  placeholder="Full Discription" name="profile_desc"  required></textarea>
                                    <div class="invalid-feedback">
