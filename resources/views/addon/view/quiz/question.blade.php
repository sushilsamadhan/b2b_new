...
<div class="row p-lg-5">
    <div class="col-md-10 offset-1">
        <div class="card rounded shadow">
            <div class="card-body">
                <h4 class="card-title">@translate(Start the assessment)</h4><br>

                <table class="table">
                    <tbody>
                    <tr>
                        <td>@translate(Quiz)</td>
                        <td><strong>{{$quiz->name}}</strong></td>

                    </tr>
                    <tr>
                        <td>@translate(Quiz Time)</td>
                        <td><strong>{{$quiz->quiz_time}} Min</strong></td>

                    </tr>
                    <tr>
                        <td>@translate(Pass Mark)</td>
                        <td><strong>{{$quiz->pass_mark}}</strong></td>

                    </tr>
                    <tr>
                        <td>@translate(Total Question)</td>
                        <td> <strong>{{$quiz->questions->count()}}</strong></td>
                ...
                <a class="btn btn-outline-secondary m-lg-5 float-right" href="{{$url}}">@translate(Start  the assessment)</a>
            </div>
        </div>
