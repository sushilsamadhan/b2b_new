...
@section('content')
    ...
    <script type="text/javascript" src="https://ole.org.in/public/assets/plugins/tinymce/tinymce4/plugins/tiny_mce_wiris/integration/WIRISplugins.js?viewer=image"></script>
                        ...
                        <table class="table table-striped- table-bordered table-hover text-center">
                            ...
                            @forelse($questions as  $item)
                                <tr>
                                    ...
                                    <td><?php echo html_entity_decode($item->question)?></td>
                                        ...
                                        <div class="kanban-menu">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right action-btn"
                                                    ...
                                                    <a class="dropdown-item" href="{{route('questions.edit',$item->id)}}">
...
tinymce.init({
            ...
            toolbar: 'image,|,code,|,bold,italic,underline,|,cut,copy,paste,|,search,|,undo,redo,|,forecolor,backcolor,|,justifyleft,justifycenter,justifyright,fontselect,fontsizeselect,|,tiny_mce_wiris_formulaEditor,tiny_mce_wiris_formulaEditorChemistry,|,fullscreen',
