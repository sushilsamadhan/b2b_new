...
<script src="{{asset('assets/js/custom/custom-form-select.js')}}"></script>
    <div class="card m-2">
        ...
        <div class="card-body">
        <form action="{{ route('testquestions.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
             <div class="container">                    
                <div class="row">
                ...
                <!----   Board End   --->
                    ...
                    <div class="form-group col-md-3 p-3">
                        ...
                        <select class="form-control langr selectpicker" id="question_type" name="question_type">
                                <option value="1" {{ (old('question_type')=='1')?'selected':'' }}>Single Selection</option>
                                <option value="2" {{ (old('question_type')=='2')?'selected':'' }} disabled>Multiple Selection</option>
                                <option value="3" {{ (old('question_type')=='3')?'selected':'' }} disabled>Paragraph</option>
                            </select>
                        </div>
