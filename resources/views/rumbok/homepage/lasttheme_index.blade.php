            ...
            <div class="col-lg-6 align-self-center">
                    <div class="hero-content">
                        ...
                        <div class="hero-button">
                            <a href="{{route('student.register')}}" class="template-button">@translate(Experience Now)</a>
                        </div>
                        @endguest
						<div class="float-left">
							<br/>
							<i class="icofont-megaphone promo">&nbsp;powered by:</i>
							<a href="https://samadhan.group" target="_blank"><img src="{{asset('sm-sama-logo.png')}}" class="home_img_promoted"></a>
                        </div>
						<div class="float-left" style="margin-left:5px">
							<br/>
							<i class="fa fa-copyright promo">&nbsp;incepted by:</i>
							<a href="https://iid.org.in" target="_blank"><img src="{{asset('sm-TV-logo.png')}}" class="home_img_incubated"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
...
{{--    {{print_r(allBlogTags())}}--}}
   ...
   {{-- <div class="container">
		<div class="row mt-5">
			<div class="col-lg-8 offset-lg-2 col-12">
				<img  src="{{asset('uploads/media_manager/51.jpg')}}" alt="image">
			</div>
		</div>
	</div>--}}
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        <h2>@translate(trending) <span>@translate(categories)</span></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="{{route('course.category',$item->slug)}}">
                            <div class="single-category-item">
                                ...
                                @php
                                    $subCategories = \App\Model\Category::Published()->where('parent_category_id', $item->id)->pluck('id');
                                    $subCategories->push($item->id);
                                    $courseCount = \App\Model\Course::Published()->whereIn('category_id',$subCategories->toArray())->count();
                                @endphp
                                <span>{{$courseCount}} @translate(course(S))</span>
                            </div>
                        </a>
                    </div>
                @endforeach
                <div class="col-lg-3 col-md-6">
                    <a href="{{route('iid.courses.list')}}">
                        <div class="single-category-item">
                            <div class="category-image">
                                <img src="{{asset('iid-icon.png')}}" alt="Industrial Courses">
                                <img src="{{asset('asset_rumbok/images/round-shape-3.png')}}" alt="shape"
                                        class="feature-round-shape-3">
                            </div>
                            <div class="category-title margin-bottom-10">
                                <h4>Industrial Courses</h4>
                            </div>
                           
                            <span>10 @translate(course(S))</span>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center margin-bottom-40">
                        <h2>@translate(popular) <span>@translate(courses)</span></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                @foreach($course as $items)
                    @if($items->count() > 0)
                        @foreach($items->take(2) as $course)
                            <div class="col-lg-3 col-md-6 grid-item tab-{{$j}}">
    ...
    <section class="counterup-section padding-top-10">
        <div class="container">
                ...
                <div class="row align-items-center">
                        ...
                        <div class="single-counterup">
                            ...
                            <div class="single-counterup-content">
                                <div class="counter-number">
                                    <h3 class="title counter">{{(55+\App\User::where('user_type','Instructor')->get()->count())}}</h3>
                                    <h3 class="title">+</h3>
                                </div>
                                <span>@translate(Subject Matter Expert)</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-sm-6">
                        <div class="single-counterup">
                            ...
                            <div class="single-counterup-content">
                                <div class="counter-number">
                                    <h3 class="title counter">{{(2000+\App\Model\Enrollment::count())}}</h3>
                                    <h3 class="title">+</h3>
                                </div>
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="single-counterup">
                            ...
                            <div class="single-counterup-content">
                                <div class="counter-number">
                                    <h3 class="title counter">{{(6000+\App\Model\Course::Published()->count())}}</h3>
                                    <h3 class="title">+</h3>
                                </div>
                                <span>@translate(Hours of content)</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="instructor-section gradient-bg">
        <div class="container">
            ...
            <div class="row">
                @foreach(\App\Model\Instructor::with('courses')->whereNotIn('id',[20])->get()->random(4) as $instructor)
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-instructor {{$loop->index++ %2 == 0 ? 'diffrent-bg-color' : ''}}">
                                ...
                                <div class="instructor-image">
                                    <a  href="javascript:void(0);"><img style="background-image: url('{{filePath($instructor->image)}}')"
                                           class="ins-thum"
   ...
   ======================================-->
    ...
    <div class="container">
            <div class="row mt-5">
                <div class="col-lg-12">
                    <a href="https://www.youtube.com/watch?v=DURvDKyEzpU" target="_blank"><img  src="{{asset('current_affairs_banner.jpg')}}" alt="image"></a>
                </div>
            </div>
        </div>
    <!--======================================
    ...
    <section class="about-section padding-top-115">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        <h2>@translate(how we) <span>@translate(function)?</span></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        @php
                            $color = array('green-icon','yellow-icon','blue-icon','pink-icon','lb-icon','yellow-icon');
                            $i = 0;
                        @endphp
                        @foreach(\App\KnowAbout::where('align','left')->get()->take(6) as $leftContent)
                        <div class="col-lg-4">
                        ...
                        @foreach(\App\KnowAbout::where('align','right')->get()->take(6) as $leftContent)
                        <div class="col-lg-4">
