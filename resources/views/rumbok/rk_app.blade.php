...
<head>
    ...
    <!-- inject:css -->
    <link rel="stylesheet" href="{{asset('asset_rumbok/new/css/main.css')}}"/>
                                    ...
                                    @auth
                                        ...
                                        <a class="user-btn show-mobile" data-toggle="collapse" href="#usermenucollapse" role="button" aria-expanded="false" aria-controls="usermenucollapse"><i class="ti-user"></i></a>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{ route('my.projectwork') }}"><span class="mr-1"><i class="ti-video-camera"></i></span> My Projectwork</a>
