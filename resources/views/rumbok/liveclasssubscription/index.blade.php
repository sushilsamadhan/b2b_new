    ...
    <section class="heading-n-breadcrub-part bg-form-live-class">
         <div class="container">
            <div class="row align-items-center">
               ...
               <div class="col-md-6">
                <div class="ticker-part">
                   <div class="row">
                      <div class="col-md-6">
                         <h4>Offer available till 30th Mar 2022 only</h4>
                      </div>
                      <div class="col-md-6">
                ...
                <div class="form-register-now">
                   <h3 class="text-center"><span class="font-weight-normal">Book your LIVE classes by</span></br> India's Top Educators</h3>
                  ...
                  <input type="hidden" name="instructor_live_class_id" value="{{(isset($instructor_live_class_id))?$instructor_live_class_id:''}}">  
                   <div class="row">
                     ...
                     <div class="col-md-12 otp-row" style="display:none;">
                        ...
                        <div class="col-md-6 other_forms_fields">
                           <div class="form-group">
                              <select name="stream" id="stream" class="form-control form-control-sm @error('stream') is-invalid @enderror" >
                     ...
                     <div class="col-md-12" id="checkMobileValidation">
                        ...
                        <input type="button" id="book_free_trial_checkvalidation" value="Subscribe For Free Live Classes" class="btn-free-trial-class">
