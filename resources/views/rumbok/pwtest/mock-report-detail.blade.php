  ...
  <div class="container">
      <div class="row">
          ...
          <div class="col-lg-6">
              ...
              <a href="{{ route('pw-mock-test-package' ,[$packageDetail->id, $mockTestEnrollment->mock_test_id]) }}" type="botton" class="btn btn-danger">View Reports</a>
...
<section class="clearfix">
    <div class="container">
        ...
        <div class="row" id="product-gallery-holder-2222">
            @include('rumbok.pwtest.component.mock-report-test-start-filter')            
        </div>
    </div>
</section>
<!--======================================
