    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-12">
                ...
                @endphp
                    <h1 class="mb-2">{{ $packageDetail->pkg_name }} Practice Test - Attempt {{ $countAttempt->count() }}</h1>
                </div>
            </div>
            <div class="col-lg-2 col-8">
                <div class="clearfix">
                <a href="{{ route('report-detail' ,[$packageDetail->id, $mockTestEnrollment->id]) }}" type="botton" class="btn btn-danger btn-block">View Solution</a>
                </div>
            </div>
...
<section class="clearfix">
    ...
    <div class="row">
            ...
            <div class="col-md-4">
                <div class="analytic-card-1 sea-blue">
                    <div class="d-flex align-items-center">
                        ...
                        $totalIncorrect =  $studentTestQuestionsAttend->count() -  ($getTotalMarks*2);
                ...
                <div class="analytic-card-1 light-red">
                    <div class="d-flex align-items-center">
                        <div class="heading-and-count">
                            ...
                            $gainMask = $getTotalMarks *2 ;
                            $totalQuestionMask = $studentTestQuestions->count() *2 ;
                             $newPercentage = ( $gainMask / $totalQuestionMask) * 100; @endphp
        ...
        <div class="row">
            ...
            @if($mockTestEnrollment->test_type == 'unit' ||$mockTestEnrollment->test_type == 'subject' )
            <div class="col-md-12">
                <div class="card mt-3 mb-4">
                    <div class="card-header py-2">
                        <div class="card-title mb-0">
                    ...
                    <div class="card-body">
                        <div class="Rtable Rtable--5cols Rtable--collapse">
                            ...
                            <div class="Rtable-row">
                                ...
                                <div class="Rtable-cell--heading">Attempted</div>
            ...
            <div class="col-md-12">
                <div class="card mt-3 mb-4">
                    <div class="card-header py-2">
                        <div class="card-title mb-0">
                            <p class="mb-0">Chapter wise distribution</p>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="Rtable Rtable--5cols Rtable--collapse">
                            <div class="Rtable-row Rtable-row--head">
                                <div class="Rtable-cell date-cell column-heading">Chapter</div>
                                <div class="Rtable-cell topic-cell column-heading">Attempted</div>
                                <div class="Rtable-cell access-link-cell column-heading">Correct</div>
                                <!-- <div class="Rtable-cell replay-link-cell column-heading">Accuracy</div> -->
                            ...
                            <div class="Rtable-row">
                                <div class="Rtable-cell date-cell">
                                    <div class="Rtable-cell--heading">Chapter</div>
                                   @php  $getClassContent = \App\Model\ClassContent::where('id', $arrayValue)->first();@endphp
                  
                                    @if($getClassContent)
                                    <div class="Rtable-cell--content date-content"><span class="webinar-date">Chapter - {{ $i++ }} - {{ $getClassContent->title }}</div>
                                    @endif
                                </div>
                                @php  
