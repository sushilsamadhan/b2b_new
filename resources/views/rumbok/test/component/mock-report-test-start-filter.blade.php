    ...
    <div class="clearfix">
                ...
                <div class="container">
                    <div class="d-flex">
                        ...
                        <div class="text-right ml-auto ">
                            <a class="btn btn-success " href="{{ route('mock_analytical_report' , [$packageDetail->id ,Request::segment(3)])}}">Graphical Report</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div role="" class="clearfix" id="work">
            ...
            <div class="tab-content">
                ...
                @php $section = \App\MockTestSection::where('id' , $keys)->first(); @endphp
                <div id="section{{ $section->id }}" class="tab-pane fade show {{  $keys ==  $studentTestQuestions[0]['section_id']  && $key  ? 'active': '' }}">
