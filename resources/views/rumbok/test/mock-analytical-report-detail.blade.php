        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="bread-crumb-part">
                    <a href="{{ route('mock-report-detail' ,[$packageDetail->id, $mockTestEnrollment->id]) }}" type="botton" class="btn btn-danger">View Solution</a>
                </div>
            </div>
            <div class="col-lg-2">
                <div class="clearfix">
                    ...
                    <input type="button" value="Back" class="btn btn-success" data-dismiss="modal" id="btnHome" onClick="document.location.href='{{ url('')}}/package/{{$path}}/{{$path1}}'" />
                    @else
