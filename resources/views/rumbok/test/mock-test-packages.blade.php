                                    ...
                                    <div class="card__info">
                                              @if($getTestReports->count() != 0)
                                                        ...
                                                        <p> <span class="badge bg-warning text-dark"> {{ $getTestReports->count() }}/{{ $packageDetail->no_of_sectional_test }}</span>    </p>  
                                                            <p><a href="{{ route('mock-test-detail',[$packageDetail->id , $mockTests->id]) }}" class="btn btn-success">Re-attempt</a> </p>
                                                            @else
                                                            <p><span class="badge bg-warning text-dark"> {{ $getTestReports->count() }}/{{ $packageDetail->no_of_sectional_test }}</span></p>
                                                        ...
                                                        <p><a href="{{ route('mock-test-detail',[$packageDetail->id , $mockTests->id]) }}" class="btn btn-primary">Attempt</a></p>
                                                        @endif
                                    </div>
                                </div>
                              ...
                              @foreach($getTestReports as $getTestReport)
                                ...
                                <div class="col-lg-6">
                                  ...
                                  $studentTestQuestions = \App\MockTestEnrollmentAnswer::where(['mock_test_enrollment_id' => $getTestReport->id , 'package_id'=> $packageDetail->id , 'user_id' => $getTestReport->user_id])->get();
                                   ...
                                   $getTotalMarks = getTotalMarks($getTestReport->id ,$packageDetail->id);  @endphp
                                  <h3>{{ $getCreated }} <span class="badge badge-primary float-right"> {{ $getTotalMarks * 2 }}/{{ $studentTestQuestions->count() *2 }}</span></h3>          
