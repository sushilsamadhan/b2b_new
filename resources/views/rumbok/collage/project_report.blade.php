            ...
            <div class="col-md-3">
                <div class="d-none d-md-block d-lg-block" id="sticky_sidebar_wrapper_destop">
                    <div class="sidebar-ic-desktop" id="sticky_sidebar_destop">
                        ...
                        <div class="sidebar-ic-list">
                            <a href="{{route('project.report')}}" class="d-block py-3">View All</a>
                            <ul>
                                @foreach($projectCategories as $sector)
                                    <li><a href="{{route('project.report',[$sector->slug])}}" class="@if(Request::segment(2)==$sector->slug) active @endif">{{$sector->name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                ...
                <div id="mySidebar" class="sidebar-ic">
                    ...
                    <div class="sidebar-ic-list">
                        ...
                        <ul>   
                            @foreach($projectCategories as $sector)
                                <li><a href="{{route('project.report',[$sector->slug])}}">{{$sector->name}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                ...
                <div class="row my-2">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="search__container">
                            ...
                            <input type="hidden" id="searchUrl" value="https://olexpert.org.in/industries-courses-search/cold-storage-cold-chain-solution">
                ...
                <div class="hp-course-carousel-block">
                    <div class="hp-course-carousel">
                        <div class="d-flex align-items-center">
                            <a href="{{ route('project.report.cateSubcate', [$projectContentsVal->cateSlug,$projectContentsVal->slug]) }}" class="card__img" title="Mushroom Cultivation Business">
                            ...
                            <div class="hp-course-carousel-content">
                                <div class="row">
                                    <div class="col-md-8">
                                        <h5>
                                            <a href="{{ route('project.report.cateSubcate', [$projectContentsVal->cateSlug,$projectContentsVal->slug]) }}" title="Cold Chain Storage Business">{{$projectContentsVal->title}}</a>
                                        </h5>
                                        <p>
                                        ...
                                        <p id="shortdesc{{$projectContentsVal->id}}">    
                                            {{ \Illuminate\Support\Str::limit($projectContentsVal->short_description, 150, $end='...') }}
                                    ...
                                    <div class="col-md-4 text-center border-left">
                                        ...
                                        <div class="btn-add-to-card-hp my-3">
                                            ...
                                            <span class="d-block">
                                                <a href="{{ route('project.report.cateSubcate', [$projectContentsVal->cateSlug,$projectContentsVal->slug]) }}" class="small link-btn">Preview</a>
                                            </span>
                                        </div>
                                    </div>
                                </div>
