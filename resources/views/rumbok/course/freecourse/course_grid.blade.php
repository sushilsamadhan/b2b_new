    ...
    <div class="container">    
        ...
        <div class="row">
            ...
            @forelse($courses as $course)
                ...
                @php
    $filesexitsCheck=filesexitsCheck('https://courses.iid.org.in/public'.$course->image);
@endphp          
                            <div class="thumbnail-image">

                            @if($filesexitsCheck==1)
                                <img src="{{ 'https://courses.iid.org.in/public'.$course->image }}" alt="{{ $course->image }}"/>
                            @endif
                            @if($filesexitsCheck==0)
                                    @if($course->user_id == 5)
                                        <img src="https://olexpert.org.in/public/{{ $course->image }}" alt="{{ filePath($course->image) }}"/>
                                    @else
