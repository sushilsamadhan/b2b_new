                                                    ...
                                                    @php  //if($content->provider=='Youtube')  'Youtube','HTML5','Vimeo','File','Live','Quiz' @endphp
                                                            <div class="single-course-video pb-1 d-block" onclick="contentData('{{$content->id}}')">
                                                                ...
                                                                <input type="hidden"
                                                                    ...
                                                                    value="{{route('trial.class.content',$content->id)}}">
                    ...
                    <div class="course-video-tab pl-0 pt-2">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="alert alert-danger text-center">
                                    <h6 class="text-danger">Comment section is available in paid version of this course.</h6>
                                    <a href="{{$returnUrl}}" class="btn btn-primary" type="submit" id="comment_submit">Buy This Course <i class="fa fa-arrow-right"></i></a>
                                </div>
                                
                            </div>

                            {{--<div class="tab-pane fade in note-content" id="mindmap">
                                <div class="alert alert-danger text-center">
                                    <h6 class="text-danger">Mindmap is available in paid version of this course.</h6>
                                    <a href="{{$returnUrl}}" class="btn btn-primary" type="submit" id="comment_submit">Buy This Course <i class="fa fa-arrow-right"></i></a>
                                </div>
                            </div>--}}
                                                                                                    ...
                                                                                                    <input type="hidden"
                                                                                                        ...
                                                                                                        @if ($content->is_preview == 1)
                                                                                                            <div class="row">
                                                                                                                ...
                                                                                                                <div class="col-4">
                                                                                                                    <span class="time-span px-1 small line-height-1 float-right p-2" id=""> <a href="{{ route('lesson.view_mind_map_demo',$content->id) }}" id="mindLink_{{$content->id}}" class="badgemm "><span>Mind Maps <i class="fas fa-badge-check"></i></span></a> </span>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                                ...
                                                                                                                <div class="col-5">
                                                                                                                    <span class="time-span px-1 small line-height-1 float-right p-2"> <a href="{{ route('lesson.view_mind_map_demo',$content->id) }}" class="badgemm " id="mindLink_{{$content->id}}" ><span>Mind Maps <i class="fas fa-badge-check"></i></span></a> </span>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <?php $mindMaps[] = $content->id;?>
                                                                                                        @endif
                                                                                            ...
                                                                                            <div class="single-course-video pb-1 d-block" onclick="contentData('{{$content->id}}')">
                                                                                                ...
                                                                                                @if ($content->is_preview == 1)
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-4 text-right">
                                                                                                            <span class="time-span px-1 text-right d-block v-small"> <a href="{{route('lesson.view_mind_map_demo',$content->id)}}" class="badgemm"  id="mindLink_{{$content->id}}"><span>Mind Maps <i class="fas fa-badge-check"></i></span></a> </span>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <?php $mindMaps[] = $content->id;?>
                                                                                                @else
