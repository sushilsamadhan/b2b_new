                                    ...
                                    <div class="col-lg-5">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <span>{{ucfirst(strtolower($item->package_type))}} - {{$item->category_name}}</span>
                                                {{-- <span>@translate(by) <a
                                    ...
                                    <div class="col-lg-5">
                                        <div class="row align-items-center">
                                            ...
                                            <?php //echo "<pre>"; ucfirst(strtolower($item->package_type));?>
                                                ...
                                                <span>{{ucfirst(strtolower($item->package_type))}} - {{$item->category_name}}
                            ...
                            <!-- coupon -->
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <figure>
                                            <figcaption>
                                                <h5>@translate(Coupon Code Applied): <span
                                                            class="badge badge-success">{{ $coupon }}</span></h5>

                                                            <br>

                                                <h5>@translate(Discounted Amount): 
                        ...
                        <div class="shopping-cart-detail-item border py-2 px-2">
                            ...
                            <div class="shopping-cart-content pt-2">
                                ...
                                <div class="btn-box mt-4">
                                    <a href="{{route('free.payment')}}" class="btn btn-info">@translate(Checkout)</a>
                                </div>
                                @else
                                {{-- checkout --}}
                                ...
                                {{-- PAYUMONEY PAYMENT GATEWAY --}}
                                    ...
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        ...
                                        <input type="hidden" id="key" name="key" value="CaertTiG" />
                                        <input type="hidden" id="salt" name="salt" value="Uuio8LHKPl" />
                                        ...
                                        <div class="card">
                                            <input type="submit" class="btn btn-primary" value="Pay" onclick="launchBOLT(); return false;" />
                                        </div>
                                    </form>
...
@section('js')
   ...
   <script id="bolt" src="https://sboxcheckout-static.citruspay.com/bolt/run/bolt.min.js" bolt-
    color="e34524" bolt-logo="https://iid.org.in/favicon.png"></script>
