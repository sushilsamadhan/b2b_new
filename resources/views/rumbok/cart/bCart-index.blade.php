                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-5">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4">
                                                    <a href="">
                                                        <img src="https://iid.org.in/storage/{{$item->thumbnail}}" alt="{{$item->title}}" class="img-fluid">
                                                    </a>
                                                </div>
                                                <div class="col-lg-8">
                                        ...
                                        <div class="col-lg-7">
                                            <ul class="list-inline d-flex justify-content-between align-items-center">
                                                ...
                                                <li class="list-inline-item"><a href="{{route('bcart.remove',[$item->cartId])}}"
