            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="header-widget header-widget1">
                        ...
                        <li>
                                <a href="#-"><img src="{{asset('sm-sama-logo.png')}}" /></a>
                            </li>
                            {{-- <li>
                ...
                <div class="col-lg-6">
                    <div class="header-widget header-widget2 d-flex align-items-center justify-content-end">
                        ...
                        <ul class="tvlogosec">
								<li> <a href="#-"><img src="{{asset('sm-TV-logo.png')}}" /></a></li>
						</ul>
                            {{-- <ul class="mt-3">
                                 <li><a href="{{ route('frontend.book-free-class.index') }}" > <i class="fa fa-book" aria-hidden="true"></i> Book Free Class</a></li> 
