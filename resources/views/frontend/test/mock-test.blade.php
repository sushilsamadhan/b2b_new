                        ...
                        <div class="col-md-9">
                            <div class="row">
                              @foreach($getTestReports as $getTestReport)
                                <div class="col-lg-6">
                                  <a href="{{ route('report-detail' , $packageDetail->id) }}" class="data-card">

                                  @php $getCreated =  getCreatedAtAttribute($getTestReport->created_at) ;@endphp
                                      <h3>{{ $getCreated }} <span class="badge badge-primary float-right">0/{{ $getTestReport->MockTestEnrollmentAnswer->count() *2 }}</span></h3>
