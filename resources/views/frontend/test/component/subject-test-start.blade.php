...
<section class="">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                {{ $packageDetail->subjectName->title}}</p>
            </div>
             </div>
    ...
    <div class="course-content-wrapper mt-4">
     <div class="container-fluid">
        ...
        @include('frontend.test.component.subject-test-start-filter')
...
onClick="document.location.href='https://ole.org.in/'" />
        </div>
        </div>
...
var id = $('.content:visible').data('id');
   ...
   // alert(dataId)
    ...
    $.ajax({
        ...
        data:{
            id: dataId,section:dataSelection,type:type,pacakge_id:pacakge_id,testType:testType
        },
...
$.ajax({
        ...
        data:{
            pacakge_id:pacakge_id,testType:testType
        },
        success: function(data) {
   ...
   // $('input[name="ans-'+dataId+'"]').prop("checked", true);
    if(checked){
        ...
        $.ajax({
            ...
            url: "{{ route('question-subject-update') }}",
            data: {
                id: dataId,section:dataSelection,type:type,answer:checked,pacakge_id:pacakge_id,testType:testType
            },
            success: function(data) {
                //console.log(data.visited); 
                $("#visited").html(data.visited);
...
$('body').on('click', '.mark_review_next', function() {
    ...
    $.ajax({
        ...
        url: "{{ route('question-subject-update') }}",
        data: {
            id: dataId,section:dataSelection,type:type,testType:testType,pacakge_id:pacakge_id
        },
        success: function(data) {
            //console.log(data.visited); 
            $("#visited").html(data.visited);
