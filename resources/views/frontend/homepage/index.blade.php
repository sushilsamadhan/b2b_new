...
=================================-->
                        ...
                        <div class="slide-item-tablecell">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="section-stuimage">
                                           <img src="{{asset('student_PNG66.png')}}" alt="banner" class="img-responsive">
                                        </div>
    ...
    =================================-->
<!---->
<section class="learning-skills-sec">
	<div class="container">
		<div class="row">
                                            ...
                                            @foreach($items as $c_tooltip)
                                                <div class="tooltip_templates">
                                                    <div id="tooltip_content_{{$c_tooltip->id}}">
                                                        <div class="card-item">
                                                            <div class="card-content">
                                                            @if($c_tooltip->relationBetweenInstructorUser)
            ...
            <div class="row">
                <div class="col-lg-3 column-td-half">
                    <div class="counter-item">
                        ...
                        <h4 class="count__title text-color-2 " >200K+</h4>
                        <p class="count__meta">@translate(Training Completed)</p>
                ...
                <div class="col-lg-3 column-td-half">
                    <div class="counter-item">
                        ...
                        <h4 class="count__title  count__title text-color-2" >600</h4>
                        <p class="count__meta">@translate(hours of video contents)</p>
                    </div><!-- end counter-item -->
                </div><!-- end col-lg-3 -->
                <div class="col-lg-3 column-td-half">
                    <div class="counter-item">
                        ...
                        <h4 class="count__title  count__title text-color-2" >1K+</h4>
                ...
                <div class="col-lg-3 column-td-half">
                    <div class="counter-item">
                        ...
                        <h4 class="count__title count__title text-color-2 " >500</h4>
