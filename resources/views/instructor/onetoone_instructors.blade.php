...
<div class="card mx-2 mb-3">
    <div class="card-header">
        <div class="float-left">
            <h3>@translate(One To One Instructors)</h3>
        </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right action-btn" aria-labelledby="KanbanBoardButton1" x-placement="bottom-end">
                                    ...
                                    <a class="dropdown-item" href="{{ route('instructors.edit', $item->user_id) }}">
                                        <i class="feather icon-edit-2 mr-2"></i>
                                        @translate(Edit)</a>
                                    <a class="dropdown-item" href="{{ route('tutition-assessment', $item->id) }}">
                                    <i class="feather icon-edit-2 mr-2"></i>
                                    @translate(Class Subject)</a>
                                    <a class="dropdown-item" href="{{ route('tutition-schedule',$item->id) }}">
                                    <i class="feather icon-edit-2 mr-2"></i>
