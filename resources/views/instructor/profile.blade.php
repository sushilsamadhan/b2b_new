                            ...
                            <div class="tab-pane fade show active" id="information" role="tabpanel"
                                ...
                                <div class="widget-body">
                                    ...
                                    <div class="form-group row d-flex align-items-center mb-5">
                                        <label class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(Name)</label>
                                        <div class="col-lg-6">
                                            <input type="tel" name="name" class="form-control"
                                                   placeholder="Enter Instructor name" value="{{ $each_user->name }}">
                                        </div>
                                    </div>
                                    <div class="form-group row d-flex align-items-center mb-5">
                                    ...
                                    <div class="form-group row d-flex align-items-center mb-5">
                                        <label class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(Heighst Qualification)</label>
                                        <div class="col-lg-6">
                                            <input type="text" name="heighst_qualification" class="form-control"
                                                   placeholder="Heighst Qualification" value="{{ $each_user->heighst_qualification }}">
                                        </div>
                                    </div>

                                    <div class="form-group row d-flex align-items-center mb-5">
                                        <label class="col-lg-2 form-control-label d-flex justify-content-lg-end">@translate(Total Experience)</label>
                                        <div class="col-lg-6">
                                            <input type="text" name="total_experience" class="form-control"
                                                   placeholder="Total Experience" value="{{ $each_user->total_experience }}">
                                        </div>
                                    </div>
                                    <div class="form-group row d-flex align-items-center mb-5">
