...
@section('content')
    ...
    <div class="card-header">
        ...
        <div class="container">
            <div class="col-md-12">
                                <form id="myForm" class="form-horizontal" action="{{ route('save-tutition-assessment') }}" method="post"
...
{{-- Category --}}
                    ...
                    {{--<div class="col-md-3">
                        <div class="form-group col-md-12 p-3" id="board_view">
                            <label class="" for="val-course_id">@translate(Timing) <span class="text-danger"></span></label>
                            <div class="">
                                <select class="form-control langr @error('course_id') is-invalid @enderror"
                                        id="val-time_slot" name="time_slot">
                                <option value=""> @translate(Please Select Time)</option>
                                <option value="8to11">8 To 11</option>
                                <option value="11to2">11 To 2</option>
                                <option value="2to5">2 To 5</option>
                                </select>
                            </div>
                        </div>--}}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endif
                                     ...
                                     {{--<td>
                                         {{ $instructorAssessment->time_slot }}
                                     </td>--}}
                                    <td>

{{--<a class="" href="{{ route('tutition-schedule',$instructorAssessment->id) }}">@translate(Add Schedule)</a>--}}
...
//         e.preventDefault();
//         var subject_id = $('#val-course_id').val();

//         var course_id = $('#val-category_id').val();
//         var class_id = $('#val-sub_category_id').val();
//         var time_slot = $('#val-time_slot').val();
//         if (course_id == '') {
...
//             };
//             $.ajax({
//             url: "{{route('check-tutition-available')}}",
//             type: "GET",
//             data: values,
...
//                     $.ajax({
//                         type : 'POST',
//                         url : "{{ route('save-tutition-assessment') }}",
//                         data : $('#myForm').serialize(),
//                         success: function(response) {
//                         swal({
//                             title: "",
//                             content: "Tution subject Added successfully",
//                             icon: "success",
//                             buttons: "Okay",
