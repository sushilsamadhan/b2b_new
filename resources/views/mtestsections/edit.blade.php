    ...
    <div class="card m-2">
        <div class="card-header">
            <div class="float-left">
                <h3>Update Mock Test Section</h3>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 p-3">
                        <label class="" for="no_of_question">
                            @translate(Number of Question) </label>
                            <div class="">
                    ...
                    <div class="form-group col-md-4 p-3">
                        <label class="" for="section_time">
                            @translate(Total Time) (HH:MM) </label>
                            <div class="">
                                <input type="text"  class="form-control langr" placeholder="HH:MM"  id="section_time" name="section_time" value="{{$mtestsection->section_time}}">
                            </div>
                    </div>

                    <div class="form-group col-md-4 p-3">
                        <label class="" for="question_value">
                            @translate(Question Value) </label>
                            <div class="">
                                <input type="number"  class="form-control langr" placeholder="@translate(Enter Section Value)"  id="question_value" name="question_value" value="{{$mtestsection->question_value}}">
                            </div>
                    </div>
                    <div class="form-group col-md-4 p-3">
                        <label class="" for="question_value">@translate(Negative Marking) </label>
                        <div class="">
                            <input type="text"  class="form-control langr" placeholder="@translate(Enter -Ve Marking Value)"  id="negative_marking_value" name="negative_marking_value" value="{{$mtestsection->negative_marking_value}}">
                        </div>
                    </div>
                    <div class="form-group col-md-4 p-3">
