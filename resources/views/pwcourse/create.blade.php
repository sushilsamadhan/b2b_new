...
<div class="card m-b-30">
    <h4 class="card-header">@translate(Add New Project Work)</h4>
    <div class="card-body mx-3">
        <form action="{{ route('pwcourse.store') }}" method="post"  enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                ...
                @error('mentor_id') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong> </span> @enderror
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="text" required
                           ...
                           id="val-title" name="title" placeholder="@translate(Enter Project Work Title)" aria-required="true" autofocus>
