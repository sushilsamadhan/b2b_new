...
@section('content')
    ...
    <div class="card m-b-30">
        <div class="card-body">
            ...
            <form class="form-validate" action="{{ route('pwcourse.update')}}" method="post"
                ...
                <label class="col-lg-3 col-form-label" for="val-category_id">
                    @translate(Category) <span class="text-danger">*</span></label>
                        <div class="col-lg-9"> <!--lang @error('category_id') is-invalid @enderror selectpicker-->
                            <select class="form-control" id="val-category_id" name="category_id" autofocus required>
                                <option value="">@translate(Please Category)</option>
                                @foreach($categories as $category)
                                <option value="{{$category->id}}" {{$each_course->category_id == $category->id ? 'selected':null }}>{{$category->category_name}}</option>
                                @endforeach  
                            </select>
                        </div>
            ...
            {{-- Mentor --}}
                <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="val-mentor_id">
                    @translate(Mentor) <span class="text-danger">*</span></label>
                        <div class="col-lg-9"> <!--lang @error('mentor_id') is-invalid @enderror selectpicker-->
                            <select class="form-control" id="val-mentor_id" name="mentor_id" autofocus required>
                                <option value="">@translate(Please select Mentor)</option>
                                @foreach($mentors as $mentor)
                                <option value="{{$mentor->id}}" {{ ($each_course->mentor_id == $mentor->id) ? 'selected':null }}>{{$mentor->name}}</option>
                                @endforeach  
                            </select>
                        </div>
                @error('category_id') <span class="invalid-feedback" role="alert"> <strong>{{ $message }}</strong> </span> @enderror
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label" for="val-title">
                        @translate(Project Work Title) <span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label" for="val-provider">
                        @translate(Project Work Level) <span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                ...
                {{-- Project Work Thumbnail --}}
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label" for="img">
                        @translate(Project Work Thumbnail) <span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label" for="val-is_free">
                        @translate(Free Project Work)</label>
                    <div class="col-lg-9">
...
@php
$category = \App\Model\PwCategory::find($each_course->category_id);
