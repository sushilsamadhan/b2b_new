<div class="card-body">
    <form action="{{route('categories.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <label class="form-check-label">
                <input type="radio" class="form-check-input" name="category_type" value="board" checked>Board
            </label>
            </div>
            <div class="form-check-inline">
            <label class="form-check-label">
                <input type="radio" class="form-check-input" name="category_type" value="is_compitative">Competitive
            </label>
            </div>
            <div class="form-check-inline">
            <label class="form-check-label">
                <input type="radio" class="form-check-input" name="category_type" value="is_free_study">Free Study Material
            </label>
            </div>
            <div class="form-check-inline">
            <label class="form-check-label">
                <input type="radio" class="form-check-input" name="category_type" value="is_current_affairs">Current Affairs
            </label>
            </div>
	...
	<div class="form-check-inline">
            <label class="form-check-label">
                <input type="radio" class="form-check-input" name="category_type" value="is_traditional_course">Traditional Course
            </label>
	</div>
        <div class="form-group">
