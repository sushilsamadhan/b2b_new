...
<div class="card m-b-30">
    ...
    <div class="card-body mx-3">
        <form action="{{ route('current_affairs.store') }}" method="post"  enctype="multipart/form-data">
            @csrf     
            {{-- Category --}}
            ...
            <div class="form-group row affairs_date_div">
                ...
                <div class="col-lg-9">
                    <input type="date"
                           value="{{ old('current_affairs_date')?old('current_affairs_date'):date('Y-m-d')}}"
            ...
            <div class="form-group row free-hide">
                ...
                <div class="col-lg-9">
                  <div class="switchery-list">
                      <input type="checkbox"   name="is_free" class="js-switch-success" id="val-is_free" checked/>
