        ...
        <div class="card-body">
            <table class="table table-striped- table-bordered table-hover text-center">
                ...
                @forelse($blog as  $item)
                    <tr>
                        <td>{{ ($loop->index+1)}}</td>
                        <td title="{{route('blog.details',$item->blog_slug)}}">
                            {{$item->title}}
                        ...
                        <td>{{\Illuminate\Support\Str::limit(strip_tags(html_entity_decode($item->body)),50)}}</td>
                        <td>
                            ...
                            <div class="kanban-menu">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right action-btn"
                                        ...
                                        <a class="dropdown-item" target="_blank" href="{{route('blog.details',$item->blog_slug)}}">
