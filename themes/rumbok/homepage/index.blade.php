                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="{{route('course.category',$item->slug)}}">
                            <div class="single-category-item">
                                ...
                                @php
                                    $subCategories = \App\Model\Category::Published()->where('is_popular', 1)->where('parent_category_id', $item->id)->pluck('id');
                                    $subCategories->push($item->id);
                                    $courseCount = \App\Model\Course::Published()->where('is_popular', 1)->whereIn('category_id',$subCategories->toArray())->count();
                                @endphp
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-single-item">
                        ...
                        <div class="single-blog-content">
                            <h4 class="title"><a href="{{route('blog.details',$blog->id)}}">{{\Illuminate\Support\Str::limit($blog->title,80)}}</a></h4>
                        </div>
                    </div>
                </div>
                @endforeach
