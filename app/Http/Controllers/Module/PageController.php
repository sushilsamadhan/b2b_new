...
//create form
    ...
    public function store(Request $request)
    {
        ...
        $page = new Page();
        $page->school_id = \Session::get('school_id');
    ...
    {
        $page = Page::where('id', $id)->where('school_id',Auth::user()->school_id)->firstOrFail();
    ...
    public function update(Request $request)
    {
        ...
        $page = Page::where('id', $request->id)->where('school_id',Auth::user()->school_id)->firstOrFail();
        $page->title = $request->title;
    ...
    public function destroy($id)
    {
        ...
        Page::where('id', $id)->where('school_id',Auth::user()->school_id)->delete();
