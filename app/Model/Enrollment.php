...
//    use SoftDeletes;
    ...
    {
       return $this->belongsTo(PackageSetting::class, 'package_id', 'id');
    }

    public function enrollCartPackage()
    {
       // return $this->belongsTo(PackageSetting::class, 'course_id', 'id');
        return $this->belongsTo(UserAddtocartPackage::class, 'id', 'enrollment_id');
    }
