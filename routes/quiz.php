...
Route::group(['middleware'=>['installed','auth'],'prefix'=>'dashboard'],function (){
    ...
    Route::get('quiz/questions/import/{id}','QuizController@questionsImportIndex')->name('question.import');
    Route::post('quiz/questions/store','QuizController@questionsStore')->name('questions.store');
    Route::post('quiz/questions/csvstore','QuizController@questionsCsvStore')->name('questions.csvstore');
